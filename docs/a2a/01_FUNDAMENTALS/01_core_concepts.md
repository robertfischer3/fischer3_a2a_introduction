...
1. **[Core Concepts](./docs/a2a/01_FUNDAMENTALS/01_core_concepts.md)**
   - What problems does A2A solve?
   - Key terminology and definitions
   - Basic architecture patterns

2. **[Agent Identity](./docs/a2a/01_FUNDAMENTALS/02_agent_identity.md)**
   - How agents identify themselves
   - UUID vs human-readable names
   - Identity in distributed systems

3. **[Message Types](./docs/a2a/01_FUNDAMENTALS/03_message_types.md)**
   - Request/Response pattern
   - Handshake and negotiation
   - Event streaming

4. **[Conversation Flows](./docs/a2a/01_FUNDAMENTALS/04_conversation_flows.md)**
...
1. **[Agent Cards](./docs/a2a/02_DISCOVERY/01_agent_cards.md)**
   - Structure of an Agent Card
   - Capability declarations
   - Metadata and versioning

2. **[Agent Registry](./docs/a2a/02_DISCOVERY/02_agent_registry.md)**
   - Centralized vs distributed registries
   - Service discovery patterns
   - Health monitoring and heartbeats

3. **[Capability Matching](./docs/a2a/02_DISCOVERY/03_capability_matching.md)**
...
1. **[Authentication Overview](./docs/a2a/03_SECURITY/01_authentication_overview.md)**
   - Why agent authentication is hard
   - Trust models in distributed systems
   - PKI and certificate chains

2. **[Authentication Tags](./docs/a2a/03_SECURITY/02_authentication_tags.md)**
   - How agents prove their identity
   - Signature verification
   - Nonce-based replay protection

3. **[Threat Model](./docs/a2a/03_SECURITY/03_threat_model.md)**
   - Common attack vectors
   - Malicious agent scenarios
   - Defense-in-depth strategies

4. **[Security Best Practices](./docs/a2a/03_SECURITY/04_security_best_practices.md)**
   - Input validation
   - Rate limiting
   - Audit logging
...
1. **[Protocol Messages](./docs/a2a/04_COMMUNICATION/01_protocol_messages.md)**
   - JSON message structure
   - TextPart, DataPart, FilePart
   - Message routing

2. **[Streaming & Events](./docs/a2a/04_COMMUNICATION/02_streaming_events.md)**
   - Server-Sent Events (SSE)
   - Real-time updates
   - Push vs pull patterns

3. **[Error Handling](./docs/a2a/04_COMMUNICATION/03_error_handling.md)**
...
1. **[Message Schemas](./docs/a2a/05_REFERENCE/message_schemas.md)**
   - JSON Schema definitions
   - Validation rules
   - Version compatibility

2. **[Capability Vocabulary](./docs/a2a/05_REFERENCE/capability_vocabulary.md)**
   - Standard capability names
   - Custom capability guidelines
   - Capability hierarchies

3. **[Protocol Versions](./docs/a2a/05_REFERENCE/protocol_versions.md)**
   - Version history
...
- [Current README](../README.md) - Project overview
...
1. **Complete Beginner?**
   - Start with [Core Concepts](./docs/a2a/01_FUNDAMENTALS/01_core_concepts.md)
   - Read linearly through Fundamentals
   - Don't skip ahead

2. **Familiar with Agent Systems?**
   - Skim Fundamentals
   - Focus on [Security](./docs/a2a/03_SECURITY/01_authentication_overview.md)
   - Study code examples

3. **Security Professional?**
   - Jump to [Threat Model](./docs/a2a/03_SECURITY/03_threat_model.md)
...
### 📘 [Start with Fundamentals →](./docs/a2a/01_FUNDAMENTALS/01_core_concepts.md)
Begin at the beginning with core concepts and terminology.

### 🔐 [Jump to Security →](./docs/a2a/03_SECURITY/01_authentication_overview.md)
